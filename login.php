...
<style>
body {
  background-image: url('img/keuangan2.jpg');
            ...
            <!-- Nested Row within Card Body -->
                ...
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Selamat Datang di Sistem Informasi Inventory Keuangan di PT. Riau Mas Bersaudara</h1>
                  </div>
